...
{
    public class UserJokeLaughContext : DbContext
    {

        public UserJokeLaughContext(DbContextOptions<UserJokeLaughContext> options) : base(options)
        { }
        ...
        public DbSet<UserJokeLaugh> UserJokeLaugh { get; set; }
